...
export const brands: Brand[] = [
  {
    ...
    country: "España",
    technologies: [
      { name: "HR3 Foam", description: "Espuma de alta densidad usada en el núcleo de sus palas de gama alta para maximizar la potencia sin sacrificar demasiado el control." },
      { name: "Rough Surface", description: "Tratamiento de superficie que aumenta el efecto en el golpeo." },
    ],
    faqs: [
      { question: "¿Nox es una marca adecuada para principiantes?", answer: "Sí, además de su gama profesional tiene modelos de entrada muy accesibles en precio y prestaciones." },
    ],
  },
  {
    slug: "bullpadel",
    ...
    country: "España",
    technologies: [
      { name: "Hesacore", description: "Sistema de núcleo con foam de diferentes densidades para equilibrar potencia y control." },
    ],
    faqs: [],
  },
  {
    ...
    country: "Alemania",
    technologies: [
      { name: "Multiweight", description: "Sistema de contrapesos intercambiables en el marco para ajustar el balance de la pala." },
    ],
    faqs: [],
  },
  {
    ...
    country: "Austria",
    technologies: [
      { name: "Graphene", description: "Material que mejora la relación resistencia-peso del marco de la pala." },
    ],
    faqs: [],
  },
  {
  ...
  },
  {
    ...
    country: "Francia",
    technologies: [
      { name: "Kvi-Kick", description: "Tejido técnico que mejora la respuesta en la zona del marco sin aumentar la rigidez." },
    ],
    faqs: [],
  },
  {
